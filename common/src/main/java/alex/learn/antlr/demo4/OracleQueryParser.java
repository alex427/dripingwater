...
public class OracleQueryParser extends Parser {
    static {
    ...
    public OracleQueryParser(TokenStream input) {
        super(input);
    ...
    public static class TableNameContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(OracleQueryParser.ID, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterTableName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitTableName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitTableName(this);
    ...
    public static class Column_nameContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterColumn_name(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitColumn_name(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitColumn_name(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Function_nameContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterFunction_name(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitFunction_name(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitFunction_name(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SelectStatementContext extends ParserRuleContext {
        public TerminalNode SELECT() {
            return getToken(OracleQueryParser.SELECT, 0);
        }
        ...
        public TerminalNode FROM() {
            return getToken(OracleQueryParser.FROM, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterSelectStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitSelectStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitSelectStatement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SelectElementsContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterSelectElements(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitSelectElements(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitSelectElements(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TableSourcesContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterTableSources(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitTableSources(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitTableSources(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class WhereClauseContext extends ParserRuleContext {
        public TerminalNode WHERE() {
            return getToken(OracleQueryParser.WHERE, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterWhereClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitWhereClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitWhereClause(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LogicExpressionContext extends ParserRuleContext {
        ...
        public TerminalNode BETWEEN() {
            return getToken(OracleQueryParser.BETWEEN, 0);
        }

        public TerminalNode AND() {
            return getToken(OracleQueryParser.AND, 0);
        }

        public TerminalNode IN() {
            return getToken(OracleQueryParser.IN, 0);
        }

        public TerminalNode NOT() {
            return getToken(OracleQueryParser.NOT, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterLogicExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitLogicExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitLogicExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GroupByCaluseContext extends ParserRuleContext {
        public TerminalNode GROUP() {
            return getToken(OracleQueryParser.GROUP, 0);
        }

        public TerminalNode BY() {
            return getToken(OracleQueryParser.BY, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_groupByCaluse;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterGroupByCaluse(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitGroupByCaluse(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitGroupByCaluse(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class HavingCaluseContext extends ParserRuleContext {
        public TerminalNode HAVING() {
            return getToken(OracleQueryParser.HAVING, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_havingCaluse;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterHavingCaluse(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitHavingCaluse(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitHavingCaluse(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OrderByClauseContext extends ParserRuleContext {
        public TerminalNode ORDER() {
            return getToken(OracleQueryParser.ORDER, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterOrderByClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitOrderByClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitOrderByClause(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LimitClauseContext extends ParserRuleContext {
        ...
        public TerminalNode LIMIT() {
            return getToken(OracleQueryParser.LIMIT, 0);
        }

        public TerminalNode OFFSET() {
            return getToken(OracleQueryParser.OFFSET, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterLimitClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitLimitClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitLimitClause(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class OrderByExpressionContext extends ParserRuleContext {
        ...
        public TerminalNode ASC() {
            return getToken(OracleQueryParser.ASC, 0);
        }

        public TerminalNode DESC() {
            return getToken(OracleQueryParser.DESC, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterOrderByExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitOrderByExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitOrderByExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class GroupByItemContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterGroupByItem(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitGroupByItem(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitGroupByItem(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class LogicalOperatorContext extends ParserRuleContext {
        ...
        public TerminalNode OR() {
            return getToken(OracleQueryParser.OR, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterLogicalOperator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitLogicalOperator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitLogicalOperator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ComparisonOperatorContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterComparisonOperator(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitComparisonOperator(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitComparisonOperator(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitValue(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitValue(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class DecimalLiteralContext extends ParserRuleContext {
        public TerminalNode DECIMAL_LITERAL() {
            return getToken(OracleQueryParser.DECIMAL_LITERAL, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterDecimalLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitDecimalLiteral(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitDecimalLiteral(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TextLiteralContext extends ParserRuleContext {
        public TerminalNode TEXT_STRING() {
            return getToken(OracleQueryParser.TEXT_STRING, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_textLiteral;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterTextLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitTextLiteral(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitTextLiteral(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SelectFunctionElementContext extends SelectElementContext {
        ...
        public TerminalNode AS() {
            return getToken(OracleQueryParser.AS, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterSelectFunctionElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitSelectFunctionElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitSelectFunctionElement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class SelectColumnElementContext extends SelectElementContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterSelectColumnElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitSelectColumnElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitSelectColumnElement(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FullColumnNameContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterFullColumnName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitFullColumnName(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitFullColumnName(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregateFunctionCallContext extends FunctionCallContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterAggregateFunctionCall(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitAggregateFunctionCall(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitAggregateFunctionCall(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AggregateWindowedFunctionContext extends ParserRuleContext {
        ...
        public TerminalNode AVG() {
            return getToken(OracleQueryParser.AVG, 0);
        }

        public TerminalNode MAX() {
            return getToken(OracleQueryParser.MAX, 0);
        }

        public TerminalNode MIN() {
            return getToken(OracleQueryParser.MIN, 0);
        }

        public TerminalNode SUM() {
            return getToken(OracleQueryParser.SUM, 0);
        }

        public TerminalNode COUNT() {
            return getToken(OracleQueryParser.COUNT, 0);
        }
        ...
        public TerminalNode DISTINCT() {
            return getToken(OracleQueryParser.DISTINCT, 0);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterAggregateWindowedFunction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitAggregateWindowedFunction(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitAggregateWindowedFunction(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionArgContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterFunctionArg(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitFunctionArg(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitFunctionArg(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionArgsContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterFunctionArgs(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitFunctionArgs(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitFunctionArgs(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class UidContext extends ParserRuleContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).enterUid(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof OracleQueryListener) ((OracleQueryListener) listener).exitUid(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof OracleQueryVisitor) return ((OracleQueryVisitor<? extends T>) visitor).visitUid(this);
            else return visitor.visitChildren(this);
        }
    }
